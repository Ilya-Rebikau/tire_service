                    ...
                    <section>
                        ...
                        <article>
                            <p className="fs-4 text-center">Два брата, два профессионала своего дела, однажды решили заняться собственным
                                бизнесом и зарегистрировали ИП: так и возник наш шиномонтаж. Братья создали 2 команды, каждую из которых возглавил
                        ...
                        <article className="d-flex justify-content-center row">
                            <div className="text-center col-sm-5 border rounded border-dark bg-light bg-gradient m-3 p-3">
                                ...
                                <img className="img-thumbnail img-fluid" src="" alt="Ребиков Александр Евгеньевич"></img>
                            ...
                            <div className="text-center col-sm-5 border rounded border-dark bg-light bg-gradient m-3 p-3">
                                ...
                                <img className="img-thumbnail img-fluid" src="" alt="Ребиков Геннадий Евгеньевич"></img>
